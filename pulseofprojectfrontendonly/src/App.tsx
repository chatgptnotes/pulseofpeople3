...
import ZoneAdminDashboard from './pages/dashboards/ZoneAdminDashboard'
...
function AppRoutes() {
  ...
  return (
    <Routes>
              {/* Landing Page - Original generic landing page */}
              ...
              {/* Legacy route - redirect to new one */}
              ...
              {/* Hierarchical Multi-Party CRM Dashboards - Unique for each role */}
              ...
              <Route path="/dashboard/zone" element={
                <ProtectedRoute>
                  <Layout>
                    <ZoneAdminDashboard />
                  </Layout>
              ...
              <Route path="/dashboard/constituency" element={
                <ProtectedRoute>
                  <Layout>
              ...
              <Route path="/dashboard/booth" element={
                <ProtectedRoute>
                  <Layout>
                    <UserBoothDashboard />
                  </Layout>
              ...
              <Route path="/super-admin/admins/:id/view" element={
                <ProtectedRoute requiredPermission="manage_organizations">
                  <Layout>
                    <AdminView />
                  </Layout>
              ...
              <Route path="/super-admin/admins/:id/edit" element={
                <ProtectedRoute requiredPermission="manage_organizations">
                  <Layout>
                    <AdminEdit />
                  </Layout>
