...
export default function LandingPage() {
  ...
  const tenantName = tenant?.name || tenant?.displayName || 'Pulse of People';
  const primaryColor = tenant?.branding?.primary_color || tenant?.branding?.primaryColor || '#1976D2';
  const features = [
    {
      icon: BarChart3,
